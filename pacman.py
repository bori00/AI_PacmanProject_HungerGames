...
class GameState:
    ...
    def getMazeExitPosition(self):
        return self.data.layout.mazeExit
...
class PacmanRules:
    ...
    def consume(position, state):
        ...
        if state.data.food[x][y]:
            ...
            if state.data.layout.mazeExit != ():
                # Win-verification for hunger games problem
                if state.data.layout.mazeExit == (x, y):
